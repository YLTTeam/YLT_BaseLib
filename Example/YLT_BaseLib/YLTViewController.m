...
- (void)viewDidLoad
{
    ...
    NSString *routerURL = @"http://www.baidu.com";//@"ylt://classname/ylt_router?username=alex&password=123456";
    id vc = [YLT_RouterManager ylt_routerToURL:routerURL arg:@{@"user":@"alex"} completion:^(NSError *error, id response) {
...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    NSString *routerURL = @"http://www.baidu.com";//@"ylt://classname/ylt_router?username=alex&password=123456";
    UIViewController *vc = [YLT_RouterManager ylt_routerToURL:routerURL arg:@{@"user":@"alex"} completion:^(NSError *error, id response) {
